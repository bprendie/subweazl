...
func (m Model) helpMenu(width int) string {
	return renderHelpMenu(width, [][]helpAction{
		{{"h", "home", crushGold}, {"1", "newest", crushGold}, {"2", "playlists", crushPink}, {"3", "random", crushMint}, {"4", "queue", crushGold}, {"5", "private", crushPink}, {"y", "sync", crushMint}, {"g", "generate", crushGold}, {"/", "search", crushPurple}},
